...
import styles from "./SeolyuMouseSvg.module.css"; // CSS 모듈을 가져옵니다.

export default function SeolyuMouseSVG() {
  const svgStyle: React.CSSProperties = {
    // enableBackground: "new 0 0 708.66 708.66",
  };

  return (
    <div>
      <svg
        className={`seolyuMic ${styles.seolyuMic}`}
        viewBox="0 0 708.66 708.66"
        xmlns="http://www.w3.org/2000/svg"
      >
        <svg
          className={`${styles.seolyuMic}`}
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <g id="Layer_8">
            <path
              className={`${styles.m_st0}`}
              d="M376.11,427.68c2.81,1.36,42.12,14.06,44.94,15.32l-3.06,145.02l-41.87,26.04l-46.98-25.53l-3.06-140.94
		L376.11,427.68z"
            />
            <polygon
              className={`${styles.m_st1}`}
          ...
          <g id="Layer_7">
            <polygon
              className={`${styles.m_st0}`}
              points="276.02,480.79 276.02,618.15 316.87,655.43 376.11,617.13 372.54,470.02 322.49,447.6 278.57,478.74 	
		"
            />
            <polygon
              className={`${styles.m_st1}`}
          ...
          <g id="Layer_11">
            ...
            />
            <path
              className={`${styles.m_st2}`}
              d="M429.21,202.49l57.45,31.4l-6.3,141.8l-48.46,25.95l-54.77-26.04c0,0,0-136.34,0-134.04
		S429.21,202.49,429.21,202.49z"
          ...
          <g id="Layer_6">
            <polygon
              className={`${styles.m_st0}`}
              points="274.49,279.85 379.17,230.57 432.28,262.74 422.06,444.02 319.94,497.64 276.02,480.79 257.13,289.81 
			"
            />
            <polygon
              className={`${styles.m_st3}`}
          ...
          <g id="Layer_5">
            <path className={`${styles.m_st4}`} d="M260.19,111.6" />
            <polygon
              className={`${styles.m_st4}`}
              points="260.19,190.14 280.11,190.14 280.11,170.23 305.64,170.23 305.64,150.82 389.38,150.82 389.38,170.48 
		414.4,170.48 414.4,188.61 435.34,190.14 435.34,107.42 260.19,107.42 	"
          ...
          <g id="Layer_4">
            ...
            <polygon
              className={`${styles.m_st4}`}
              points="326.7,279.85 368.83,279.85 368.83,259.94 326.7,261.21 	"
            />
          </g>
          <g id="Layer_10">
            <polygon
              className={`${styles.m_st5}`}
              points="342.4,535.43 417.98,594.66 404.7,602.83 323,535.43 334.23,527.26 	"
            />
          </g>
          <g className={`${styles.flower}`}>
            <path
              className={`${styles.m_st6}`}
              d="M416.96,560.58c-2.55,5.35,28.6-11.23,28.6-11.23v22.47l-30.64,20.43l38.81,3.06l18.38,20.43l-22.41,2.56
		...
		l20.43,19.4L416.96,560.58z"
          ...
          <g id="Layer_14">
            <path
              className={`${styles.m_st7}`}
              d="M225.47,372.28c0,0-1.02-7.15-15.06-4.09c0,0-16.34,5.11,1.79,9.7c0,0,15.32,2.55,11.23,6.64
		...
		c0,0-3.57,12.77,3.83,14.04"
            />
            <path
              className={`${styles.m_st8}`}
              d="M306.15,378.99c0,0-7.66-10.54-1.79-11.57c0,0,1.53-2.81,4.85,4.09c0,0,6.64-3.3,5.11,1.41
